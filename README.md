...
- **Current milestone:** Phase 5 Epic 5 in progress — data display, Showcase `/phase-5-data`, composition + e2e
- **Next:** Phase 6 feedback & overlays — see [JP_ROADMAP.md](./docs/JP_ROADMAP.md)
...
```text
/apps
  /showcase            # read-only integration app (e.g. /phase-5-data)
...
- Phase 5 (in progress): `jp-badge`, `jp-empty-state`, `jp-table`, Showcase `/phase-5-data`
