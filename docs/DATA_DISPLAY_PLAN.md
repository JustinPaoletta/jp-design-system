...
Prior milestones established tokens, layout/typography primitives, an app shell, and
core controls. This epic introduces the **data display layer**: status badges, a
...
to ship a dashboard data page inside the app shell using Controls buttons for
actions.
...
Without this epic, Feedback & Overlays have nothing consistent to annotate or confirm
...
product list/detail surfaces on top of the app shell and Controls.
...
5. Showcase `/data` + composition story + e2e + docs.
