...
@Component({
  selector: 'jp-feedback-overlays-composition-host',
  standalone: true,
  imports: [
    JpAppShell,
    JpAppShellNavItem,
...
class FeedbackOverlaysCompositionHost {
...
const meta: Meta = {
  ...
  decorators: [
    moduleMetadata({
      imports: [FeedbackOverlaysCompositionHost],
    }),
  ],
  render: () => ({
    template: `<jp-feedback-overlays-composition-host />`,
  }),
};
